package com.zxn.datepicker.pickerview.lib;
...
import com.zxn.datepicker.pickerview.adapter.WheelAdapter;
import com.zxn.datepicker.pickerview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.wheelview_gravity_1, Gravity.CENTER);
