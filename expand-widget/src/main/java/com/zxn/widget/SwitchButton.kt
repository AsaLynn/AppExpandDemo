...
class SwitchButton : View, Checkable {
    ...
    protected fun drawCheckedIndicator(canvas: Canvas,
                                       ...
                                       sx: Float =
                                               left + viewRadius - checkedLineOffsetX, sy: Float = centerY - checkLineLength, ex: Float =
                                               left + viewRadius - checkedLineOffsetY, ey: Float = centerY + checkLineLength,
    ...
    interface OnCheckedChangeListener {
         ...
         * @param isChecked
         */
        fun onTouchCheckedChanged(view: SwitchButton?, isChecked: Boolean)
    }
    /** */
    /**
     * 保存动画状态
